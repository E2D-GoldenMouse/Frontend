...
{:else if currentPage === 'login'}
  <Login on:login={getusername}  on:signup={handleSignup} on:home={handleLogout} on:desktop={handleHome}/>
{:else if currentPage === 'signup'}
  <Signup on:signup={handleHome} on:back={handleLogin} on:desktop={handleHome}/>
